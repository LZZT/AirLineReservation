...
public class ManagerAction extends  ActionSupport {
    ...
    public Time getArriTime() { return arriTime; }

    public void setArriTime(Time arriTime) {
        this.arriTime = arriTime;
    }

    public String[] getDaysOperated() { return daysOperated; }

    public void setDaysOperated(String[] daysOperated) {
        this.daysOperated = daysOperated;
    }

    public String getDepartAirport() { return departAirport; }

    public void setDepartAirport(String departAirport) {
        this.departAirport = departAirport;
    }

    public String getArriAirport() { return arriAirport; }
    ...
    public String insertFlight() throws Exception {
        ...
        flight.setArrivalTime(arriTime);
        //flight.setAircraftModel();
        //flight.setAirline();
